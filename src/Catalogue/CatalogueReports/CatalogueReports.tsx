...
const Reports = () => {
    ...
    return (
        <div className="flex flex-col h-screen w-full bg-muted shadow-lg overflow-hidden font-poppins">
            {/* Header (Unchanged) */}
            <div className="flex items-center justify-between p-4 bg-card border-b border-border shadow-sm flex-shrink-0">
                <BackButton />
                <h1 className="text-2xl font-bold text-foreground m-0 flex-grow text-center">Reports</h1>
            </div>
            ...
            */}
            <div className="flex-grow p-4 overflow-y-auto bg-muted box-border">
                {isDefaultReportsView ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Link
                            ...
                            className="flex justify-between items-center bg-card p-4 rounded-sm shadow-sm border border-border text-foreground transition-all duration-200 ease-in-out hover:transform hover:-translate-y-0.5 hover:shadow-lg no-underline"
                        >
                        ...
                        <div className="flex justify-between items-center bg-card p-4 rounded-sm shadow-sm border border-border text-muted-foreground cursor-not-allowed opacity-70 relative">
                            <span className="text-lg font-medium">User Report</span>
                    ...
                    <div className="bg-card p-2 md:p-6 rounded-sm shadow-md min-h-[200px]">
                        <Outlet />
                    </div>
                )}
            </div>
