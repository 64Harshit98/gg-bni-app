                    ...
                    <div className="flex flex-col lg:flex-row gap-5 items-start">
                                        ...
                                        {cartItems.length > 0 ? cartItems.map((item) => (
                                            <div key={item.id} className="bg-white rounded-sm p-3 shadow-sm border border-gray-50">
                                                <div className="flex gap-3">
                                                    <img src={item.image} alt={item.name} className="w-14 h-14 rounded-sm object-cover" />
                                                    <div className="flex-1">
                                                        <div className="flex justify-between items-start">
                                                            <h3 className="text-[10px] font-black text-[#1A3B5D] uppercase">{item.name}</h3>
                                                            <button onClick={() => removeFromCart(item.id)} className="text-red-400 p-1 hover:bg-red-50 rounded-sm"><Trash2 size={14} /></button>
                                                        </div>
                                                        <div className="flex items-center justify-between mt-2 gap-2">
                                                            ...
                                                            <input
                                                                ...
                                                                className="flex-1 bg-gray-50 rounded-sm px-2 py-1 text-[9px] font-medium border border-gray-100 outline-none h-7"
                                                            />
                        ...
                        <aside className="hidden lg:block w-[300px]">
                            <div className="bg-white rounded-sm p-6 shadow-sm border border-gray-100 sticky top-24">
                                ...
                                <button onClick={() => step === 1 ? setStep(2) : alert('Order Placed!')} className="w-full bg-[#00A3E1] text-white py-4 rounded-sm font-black text-[10px] uppercase tracking-widest shadow-lg hover:brightness-110 transition-all active:scale-95">
