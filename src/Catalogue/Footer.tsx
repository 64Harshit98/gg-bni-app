...
function Footer({
    ...
    return (
        <div>
            <footer className="w-full bg-card border-t border-gray-50 pt-8 pb-12 shadow-sm">
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className="flex gap-8 mb-6 text-muted-foreground">
                    ...
                    <div className="space-y-2">
                        <div className="border-t border-border w-48 mx-auto">
                            <p className="text-[8px] font-medium text-muted-foreground uppercase tracking-[0.15em]">© 2026 All Rights Reserved</p>
                            <div className="mt-2 inline-block px-2 py-1 rounded-sm bg-muted">
