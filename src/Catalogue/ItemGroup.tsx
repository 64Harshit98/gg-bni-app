...
import type { ItemGroup } from '../../src/constants/models';
import { useDatabase } from '../../src/context/auth-context';
import { ROUTES } from '../../src/constants/routes.constants';
import { CustomButton } from '../../src/Components';
import { Variant } from '../../src/enums';
import { Spinner } from '../../src/constants/Spinner';
import { FiEdit2, FiTrash2 } from 'react-icons/fi';
import { ItemEditDrawer } from '../../src/Components/ItemDrawer';
        ...
        <div className="flex flex-col mb-10 bg-gray-100 w-full">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-center bg-gray-100 md:bg-white border-b border-gray-300 shadow-sm flex-shrink-0 p-2 md:px-4 md:py-3 mb-2 md:mb-0">
                ...
                <div className="flex items-center justify-center gap-6">
                    <CustomButton variant={Variant.Transparent} onClick={() => navigate(`${ROUTES.CHOME}/${ROUTES.ADD_PRODUCT}`)} active={isActive(`${ROUTES.CHOME}/${ROUTES.ADD_PRODUCT}`)}>Add Item</CustomButton>
                    <CustomButton
                                            ...
                                            <>
                                                <div className="flex items-center gap-2 overflow-hidden">
                                                    <button
                                                        ...
                                                        className="text-gray-800 font-medium truncate hover:text-[#F97316] hover:underline text-left"
                                                    >
                                                        {group.name}
                                                    </button>
                            ...
                            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-sm shadow-sm border border-gray-300">
                                <div className="flex items-center gap-2 overflow-hidden">
                                    <button
                                        ...
                                        className="text-gray-600 font-bold hover:text-[#F97316] hover:underline text-left"
                                    >
                                        Uncategorized
                                    </button>
