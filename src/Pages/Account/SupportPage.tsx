          ...
          >
            {submitted ? (
              <div className="text-center py-6">
                ...
                <p className="text-muted-foreground text-sm mt-1">Our team will reach out to you soon.</p>
                <button
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-border rounded-sm p-2 text-sm focus:ring-1 focus:ring-gray-900 outline-none"
                  />
                </div>
                <div>
