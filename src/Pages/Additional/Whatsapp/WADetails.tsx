...
const WhatsAppDetailsPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-7 px-4 sm:px-6 lg:px-8 font-sans">
            <div className="flex justify-start">
                <button
                    onClick={() => navigate(-1)}
                    className="w-10 h-10 flex items-center justify-center bg-gray-200 hover:bg-gray-300 text-gray-600 hover:text-gray-800 rounded-full transition-colors flex-shrink-0"
                    aria-label="Go back"
                >
