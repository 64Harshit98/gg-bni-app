        ...
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 font-sans">
            ...
            <div className="sticky top-0 z-50 w-full backdrop-blur-sm transition-all duration-300">
                <div className="max-w-md mx-auto px-6 py-4">
                    <button
                        onClick={() => navigate(-1)}
                        className="absolute top-1/2 right-4 -translate-y-1/2 w-8 h-8 flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-200 rounded-full transition-colors"
                        aria-label="Go back"
                    >
