  ...
  return (
    <div className="item-group-page-wrapper">
      ...
      <div className="item-group-top-bar">
        <button
          onClick={() => navigate(-1)}
          className="item-group-close-button"
        >
          &times;
        </button>
      ...
      <div className="item-group-content-area">
        ...
        {loading ? (
          ...
          <p className="item-group-no-items">
                  ...
                  <div className="item-group-edit-mode">
                    ...
                    <div className="item-group-edit-actions">
                      <button
                        ...
                        className="item-group-save-button"
                      >
                        Save
                      </button>
                      <button
                        onClick={handleCancelEdit}
                        className="item-group-cancel-button"
                      >
                        Cancel
                      </button>
                    </div>
                  ...
                  <>
                    ...
                    <div className="item-group-actions">
                      <button
                        ...
                        className="item-group-action-button edit"
                      >
                        {/* Edit Icon (SVG) */}
                        <svg
                      ...
                      <button
                        ...
                        className="item-group-action-button delete"
                      >
                        {/* Delete Icon (SVG) */}
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
