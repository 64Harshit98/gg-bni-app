...
const Purchase = () => {
  ...
  const handleAddItemRow = () => {
    setItems((prevItems) => [
      ...prevItems,
      { id: nextItemId, itemName: '', price: 0, quantity: 1 },
    ]);
      ...
      <div className="purchase-top-bar">
        ...
        <div className="purchase-nav-links">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `purchase-nav-link ${isActive ? 'active' : ''}`
            }
          >
            Purchase
          </NavLink>
        ...
        <form onSubmit={handleSavePurchase} className="purchase-form">
          ...
          <div className="form-section">
            <div className="purchase-form-group">
              <label htmlFor="partyName" className="purchase-label">
                Party Name
              </label>
              <input
                type="text"
            ...
            <div className="purchase-form-group">
              <label htmlFor="mobileNumber" className="purchase-label">
                Mobile Number
              </label>
              <input
                type="tel"
            ...
            <div className="purchase-form-group">
              <label htmlFor="emailId" className="purchase-label">
                Email Id
              </label>
              <input
                type="email"
            ...
            <div className="purchase-form-group">
              <label htmlFor="gstin" className="purchase-label">
                GSTIN
              </label>
              <input
                type="text"
                ...
                <div key={item.id} className="purchase-item-row">
                  <div className="item-input-group">
                    <label
                      ...
                      className="purchase-label sr-only"
                    >
                      Item Name
                    </label>
                    <input
                  ...
                  <div className="item-quantity-controls">
                    ...
                    <span className="purchase-quantity-display">
                      {item.quantity}
                    </span>
                    <button
                      type="button"
          ...
          <div className="purchase-total-amount-section">
            ...
            <p className="purchase-total-amount-value">
