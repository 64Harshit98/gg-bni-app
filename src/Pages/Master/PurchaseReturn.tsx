      ...
      <div className="bg-white p-6 rounded-b-lg shadow-md mt-4">
        ...
        <div className="space-y-4 mb-6">
          {returnItems.map((item) => (
            <div
              key={item.id}
              className="relative bg-gray-50 p-4 rounded-md shadow-sm border border-gray-200"
            >
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <div className="md:col-span-1 lg:col-span-1">
                  ...
                  <p className="mt-1 block w-full p-2 font-semibold text-gray-900 bg-gray-200 rounded-md">
          ...
          <button
            ...
            className="w-full py-2 text-sm font-semibold text-indigo-600 border border-dashed border-indigo-300 rounded-md hover:bg-indigo-50 transition-colors"
          >
            + Add Item
          </button>
        </div>
