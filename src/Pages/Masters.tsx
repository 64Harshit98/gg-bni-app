      ...
      <header className="glass sticky top-0 z-10 flex items-center gap-3 border-b border-border px-4 py-3">
        ...
        <div className="flex-1">
          <h1 className="text-lg font-bold tracking-tight text-foreground">
            Business <span className="text-gradient">Settings</span>
          </h1>
          <p className="text-xs text-muted-foreground">Configure how your shop works, end to end</p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <ShowWrapper requiredPermission={Permissions.ViewPurchaseReport}>
              <SettingTile
                ...
                description="Vendors, purchase defaults & flow"
            ...
            <ShowWrapper requiredPermission={Permissions.ViewPurchaseReport}>
              ...
              {/* <Link
                ...
                className="flex justify-between items-center bg-card p-4 rounded-sm shadow-sm mb-4 border border-border text-foreground transition-all duration-200 ease-in-out hover:transform hover:-translate-y-0.5 hover:shadow-lg no-underline"
              >
