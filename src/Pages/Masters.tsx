...
const Masters = () => {
  ...
  const settingsCards = [
    ...
    { to: ROUTES.PURCHASESETTING, label: 'Purchase Setting', icon: ShoppingBag },
    { to: ROUTES.USERSETTING, label: 'Users (Salesman, Admin)', icon: Users },
    { to: ROUTES.ITEMSETTING, label: 'Items Setting', icon: Tag },
    { to: ROUTES.PERMSETTING, label: 'Permission Setting', icon: ShieldCheck },
    { to: ROUTES.BILLSETTING, label: 'Bill Setting', icon: FileText },
  ];
