        ...
        {isDefaultReportsView ? (
          <>
            <ShowWrapper requiredPermission={Permissions.ViewSalesReport}>
              <Link to={ROUTES.SALES_REPORT} className="flex justify-between items-center bg-white p-4 rounded-sm shadow-sm mb-2 border border-gray-200 text-gray-800 transition-all duration-200 ease-in-out hover:transform hover:-translate-y-0.5 hover:shadow-lg no-underline">
            ...
            <ShowWrapper requiredPermission={Permissions.ViewPurchaseReport}>
              <Link to={ROUTES.PURCHASE_REPORT} className="flex justify-between items-center bg-white p-4 rounded-sm shadow-sm mb-2 border border-gray-200 text-gray-800 transition-all duration-200 ease-in-out hover:transform hover:-translate-y-0.5 hover:shadow-lg no-underline">
                <span className="text-lg font-medium">Purchase Report</span>
                <span className="text-xl text-gray-500">→</span>
              </Link>
            </ShowWrapper>
            <ShowWrapper requiredPermission={Permissions.ViewItemReport}>
              <Link to={ROUTES.ITEM_REPORT} className="flex justify-between items-center bg-white p-4 rounded-sm shadow-sm mb-2 border border-gray-200 text-gray-800 transition-all duration-200 ease-in-out hover:transform hover:-translate-y-0.5 hover:shadow-lg no-underline">
                <span className="text-lg font-medium">Item Report</span>
                <span className="text-xl text-gray-500">→</span>
              </Link>
            </ShowWrapper>
            <ShowWrapper requiredPermission={Permissions.ViewPNLReport}>
              <Link to={ROUTES.PNL_REPORT} className="flex justify-between items-center bg-white p-4 rounded-sm shadow-sm mb-2 border border-gray-200 text-gray-800 transition-all duration-200 ease-in-out hover:transform hover:-translate-y-0.5 hover:shadow-lg no-underline">
