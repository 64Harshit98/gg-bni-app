        ...
        <div className="flex flex-col min-h-screen bg-white w-full">
            ...
            <main className="flex-grow p-4 bg-gray-50 w-full overflow-y-auto box-border pb-30">
                <form onSubmit={handleSave} className="max-w-3xl mx-auto">
                    ...
                    {/* ── Card 1: Label Format ── */}
                    <div className="bg-white rounded-sm p-6 shadow-md mb-2">
                            ...
                            {FORMAT_OPTIONS.map((opt) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className={`relative cursor-pointer rounded-sm border-2 p-4 flex flex-col items-center gap-3 transition-all duration-200
                                            ${isSelected
                                    ...
                                    >
                                        ...
                                        {/* Check indicator */}
                                        {isSelected && (
                                            <div className="absolute top-2 right-2 bg-sky-500 text-white rounded-sm p-0.5 shadow-sm z-10">
                                                <FiCheck size={12} />
                                            </div>
                                        )}
            ...
            {/* ── Sticky Save Button ── */}
            <div className="fixed bottom-15 left-0 right-0 p-4 bg-transparent">
