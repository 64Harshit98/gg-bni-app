                    ...
                    <div className="mb-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div
                                ...
                                className={`cursor-pointer relative rounded-xl border-2 p-4 flex flex-col items-center gap-3 transition-all duration-200 ${settings.purchaseViewType === 'list'
                            ...
                            <div
                                ...
                                className={`cursor-pointer relative rounded-xl border-2 p-4 flex flex-col items-center gap-3 transition-all duration-200 ${settings.purchaseViewType === 'card'
                                    ? 'border-blue-600 bg-blue-50 shadow-md'
                                    : 'border-gray-200 hover:border-blue-300 bg-white'
                                    }`}
                            >
