...
export const getDefaultSalesSettings = (companyId: string): SalesSettings => ({
  ...
  gstScheme: 'none',
  enableTax: true,
  defaultTaxRate: 0,  taxType: 'exclusive',
  ...
  useEffect(() => {
    if (settings?.gstScheme === 'composition') {
      ...
      if (settings.taxType !== 'inclusive') {
        setSettings((prev) =>
          prev ? { ...prev, taxType: 'inclusive' } : null,
        );
      }
    }
  }, [settings?.gstScheme]);
        ...
        <form onSubmit={handleSave} className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleChange('salesViewType', e.target.value)
                  }
          ...
          <div className="bg-white rounded-lg p-6 shadow-md mb-2">
            ...
            <div className="flex items-center mb-2">
              <input
                ...
                onChange={(e) =>
                  handleCheckboxChange('enableRounding', e.target.checked)
                }
                className="w-4 h-4 text-sky-500 rounded focus:ring-sky-500"
              />
              <label
                htmlFor="enable-rounding"
                className="ml-2 text-gray-700 text-sm font-medium"
              >
                Enable Rounding Off
              </label>
            ...
            {settings.enableRounding && (
              <div className="ml-6 mt-2 mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200 space-y-4">
                <div>
                  <label
                    htmlFor="rounding-interval"
                    className="block text-gray-700 text-xs font-bold mb-1 uppercase"
                  >
                    Rounding Interval
                  </label>
                  <select
                    ...
                    onChange={(e) =>
                      handleChange('roundingInterval', e.target.value)
                    }
            ...
            <div className="flex items-center mb-4">
              <input
                type="checkbox"
                id="enforce-mrp"
                checked={settings.enforceExactMRP ?? false}
                onChange={(e) =>
                  handleCheckboxChange('enforceExactMRP', e.target.checked)
                }
                className="w-4 h-4 text-sky-500 rounded focus:ring-sky-500"
              />
              <label
          ...
          <div className="bg-white rounded-lg p-6 shadow-md mb-2">
            ...
            <div className="flex items-center mb-4">
              <input
                ...
                onChange={(e) =>
                  handleCheckboxChange('lockDiscountEntry', e.target.checked)
                }
                className="w-4 h-4 text-sky-500 rounded focus:ring-sky-500"
              />
              <label
                htmlFor="lock-discount"
                className="ml-2 text-gray-700 text-sm font-medium"
              >
            ...
            <div className="flex items-center mb-4">
              <input
                ...
                onChange={(e) =>
                  handleCheckboxChange('lockSalePriceEntry', e.target.checked)
                }
                className="w-4 h-4 text-sky-500 rounded focus:ring-sky-500"
              />
              <label
          ...
          <div className="bg-white rounded-lg p-6 shadow-md mb-2">
            ...
            <div className="flex items-center mb-4">
              <input
                ...
                onChange={(e) =>
                  handleCheckboxChange('allowNegativeStock', e.target.checked)
                }
                className="w-4 h-4 text-sky-500 rounded focus:ring-sky-500"
              />
              <label
            ...
            <div className="flex items-center mb-4">
              <input
                ...
                onChange={(e) =>
                  handleCheckboxChange('allowDueBilling', e.target.checked)
                }
                className="w-4 h-4 text-sky-500 rounded focus:ring-sky-500"
              />
              <label
          ...
          <div className="bg-white rounded-lg p-6 shadow-md mb-2">
            ...
            <p className="text-sm text-gray-500 mb-2">
              Select fields that must be filled before saving a sale.
            </p>
            <div className="flex items-center mb-4">
              <input
                type="checkbox"
                ...
                onChange={(e) =>
                  handleCheckboxChange('requireCustomerName', e.target.checked)
                }
                className="w-4 h-4 text-sky-500 rounded focus:ring-sky-500"
              />
              <label
                htmlFor="req-customer"
                className="ml-2 text-gray-700 text-sm font-medium"
              >
